...
import HandelNativeEvent from "./NativeHandelNativeEvent.js";
 ...
 * ```
 */
export function setSustainedPerformanceMode(enable) {
 ...
 * ```
 */
export function activateMaxPower() {
 ...
 * ```
 */
export function deactivateMaxPower() {
